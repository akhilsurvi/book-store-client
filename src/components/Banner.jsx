  ...
  return (
    ...
    <div className='flex w-full flex-col md:flex-row justify-between items-center gap-12 py-40'>
      <div className=' md:w-1/2 space-y-8 h-full'>
        ...
        <p className='md:w-4/5'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quaerat,
           dolore maxime sapiente sint sed est laudantium ducimus? 
           Non quaerat, minima sunt a sint rerum fugiat rem dolores hic ullam cupiditate.</p>
           <div>
